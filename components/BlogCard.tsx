        ...
        <Card className="overflow-hidden rounded-md ">
            ...
            <CardContent className="overflow-clip relative p-4 rounded-b-md border-2 border-t-0 border-fuchsia-600 bg-black ">
                    ...
                    <CardDescription className="text-gray-300 line-clamp-2 mb-4 z-20">
                        ...
                        variant='gooeyLeft'
                        className="border-2 border-fuchsia-600 flex items-center justify-center gap-2 group rounded-full hover:primary-foreground hover:text-primary bg-primary-foreground text-primary">
